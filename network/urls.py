...
urlpatterns = [
    ...
    path("n/about", views.about, name="about"),
    path("n/payment_process", views.payment_process, name="payment_process"),
    path("n/<int:id>/edit_profile", views.edit_profile, name="edit_profile"),
    path("n/<int:id>/updaterecord", views.updaterecord, name="updaterecord"),
    path("n/subscription", views.subscription, name="subscription"),
    path("n/<str:username>/payment", views.payment, name="payment"),
    path("n/tripcoor", views.tripcoor, name="tripcoor"),

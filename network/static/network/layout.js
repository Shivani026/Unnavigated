...
function login_popup(action) {
    ...
    if(action === 'like') {
        ...
        document.querySelector('.main_text-div').querySelector('h2').innerText = 'Follow people who inspire you';
    }
}
...
function follow_user(element, username, origin) {
    ...
    .then(() => {
        if(origin === 'suggestion') {
            element.parentElement.innerHTML = `<button class="btn btn-dark" type="button" onclick="unfollow_user(this,'${username}','suggestion')">Following</button>`;
        }
        else if(origin === 'edit_page') {
            element.parentElement.innerHTML = `<button class="btn btn-outline-dark float-right" onclick="unfollow_user(this,'${username}','edit_page')" id="following-btn">Following</button>`;
        }
...
function unfollow_user(element, username, origin) {
    ...
    .then(() => {
        if(origin === 'suggestion') {
            element.parentElement.innerHTML = `<button class="btn btn-warning" type="button" onclick="follow_user(this,'${username}','suggestion')" id="follow-btn">Follow</button>`;
        }
        else if(origin === 'edit_page') {
            element.parentElement.innerHTML = `<button class="btn btn-dark float-right" onclick="follow_user(this,'${username}','edit_page')" id="follow-btn">Follow</button>`;
        }
        else if(origin === 'dropdown') {
            ///////////////////////////////////////////////////////////////////////////////////////////
        }
